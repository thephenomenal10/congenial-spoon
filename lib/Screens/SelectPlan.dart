          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                  ...
                  height:
                      double.parse("${widget.workout.split(",").length}") * 20,
                  child: ListView.builder(
                      itemCount: widget.workout.split(",").length,
                      itemBuilder: (BuildContext ctxt, int index) {
                        return new Text(
                          "${index + 1} : ${workout1[index]}",
                          style: TextStyle(
                      ...
                      Column(children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                                image: NetworkImage(
                                    "https://firebasestorage.googleapis.com/v0/b/exerholic-e125d.appspot.com/o/app_photos%2Fyoga.png?alt=media&token=59187ade-1363-4de0-8d76-cc16d48d1d1a"),
                                fit: BoxFit.fitHeight,
                                colorFilter: new ColorFilter.mode(
                                    Colors.black.withOpacity(0.8),
                                    BlendMode.dstATop)),
                    ...
                    TableRow(children: [
                      ...
                      Column(children: [
                        Container(
                            ...
                            color: Colors.black,
                            child: Text(
                              "NOTE : Classes are    change  availability",
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 8,
                                  fontWeight: FontWeight.bold,
                      ...
                      Column(children: [
                        Container(
                            ...
                            color: Colors.black,
                            child: Text(
                              "\nsubjected to   according to of faculty.",
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 8,
                                  fontWeight: FontWeight.bold,
              ...
              Container(
                margin:
                    EdgeInsets.only(top: 0, left: 20, right: 250, bottom: 5),
                child: Text(
                  "Plans :-",
                ...
                onPressed: () {
                  ...
                  for (int i = 0; i < personaldata.documents.length; i++) {
                    if (personaldata.documents[i].documentID == user.email &&
                        personaldata.documents[i].data['Free Workout'] == '1') {
                      count = 1;
                  ...
                  if (count == 0) {
                    Navigator.pushReplacement(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                BookSlot(widget.workout, _result)));
                  }
                },
              ),
            ],
                        ...
                        onPressed: () {
                          fobj
                              .addPersonalData({
                                ...
                                'Weight':
                                    personaldata.documents[i].data['Weight'],
                                'Height':
                                    personaldata.documents[i].data['Height'],
                                'Workout':
                                    personaldata.documents[i].data['Workout'],
                                'Gender':
                                    personaldata.documents[i].data['Gender'],
                                'DOB': personaldata.documents[i].data['DOB'],
                                'Phone':
                                    personaldata.documents[i].data['Phone'],
                                'Free Workout': '0'
                              }, user.email)
                              .then((result) {})
                              .catchError((e) {
